    ...
    F: From<ShellCompoundCommand<T, W, C>>,
{
    ...
    fn simple_command(
        ...
        PipeableCommand::Simple(Box::new(SimpleCommand {
    ...
    fn compound_command_into_pipeable(
        ...
        PipeableCommand::Compound(Box::new(cmd))
    }
...
fn compress<C>(word: ComplexWordKind<C>) -> ComplexWordKind<C> {
    use crate::shell::ast::builder::ComplexWordKind::*;
    use crate::shell::ast::builder::SimpleWordKind::*;
    use crate::shell::ast::builder::WordKind::*;
